...
import { onboardingData, type Data } from '@/src/constants/data'; // Adjust the import based on your data structure
  ...
  return (
    <View style={styles.container}>
      <Animated.FlatList
        ...
        data={onboardingData} // Ensure this matches your data structure
